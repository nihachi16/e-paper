...
int EPD_7in5b_V2_test(void)
{
    ...
    UWORD Imagesize = ((EPD_7IN5B_V2_WIDTH % 8 == 0)? (EPD_7IN5B_V2_WIDTH / 8 )$
    ...
    Paint_NewImage(BlackImage, EPD_7IN5B_V2_WIDTH, EPD_7IN5B_V2_HEIGHT , 0, WHI$
    ...
    printf("show red bmp------------------------\r\n");
    Paint_SelectImage(BlackImage);
    GUI_ReadBmp("./pic/Sui_b.bmp", 0, 0);
    Paint_SelectImage(RYImage);
    GUI_ReadBmp("./pic/Sui_r.bmp", 0, 0);
    EPD_7IN5B_V2_Display(BlackImage, RYImage);
        DEV_Delay_ms(5000);
#endif
